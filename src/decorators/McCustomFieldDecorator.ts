import { getLegacyMeta, isTC39FieldContext, type McFieldMapper, registerField } from "../core/McEntityCore";
...
type CustomFieldDecoratorFunc = (valueOrTarget: undefined | object, contextOrKey: ClassFieldDecoratorContext | string | symbol) => void;

export const CUSTOM_FIELD = (fn: McFieldMapper | symbol, path?: string): CustomFieldDecoratorFunc => {
